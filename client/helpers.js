...
Handlebars.registerHelper("checkSession", function (sessionName, valToCheck) {
	return Session.equals(sessionName, valToCheck)
});

Handlebars.registerHelper("getSession", function (sessionName) {
...
Handlebars.registerHelper("truncate", function(string, max_length){
